...
namespace RSoft.Entry.Infra.Migrations
{
    ...
    [Migration("20211002113958_InitialCreateDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSoft.Entry.Infra.Tables.Entry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("ChangedBy")
                        .HasDatabaseName("IX_Entry_ChangedBy");

                    b.HasIndex("ChangedOn")
                        .HasDatabaseName("IX_Entry_ChangedOn");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("IX_Entry_CreatedBy");

                    b.HasIndex("CreatedOn")
                        .HasDatabaseName("IX_Entry_CreatedOn");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("AK_Entry_Name");
            ...
            modelBuilder.Entity("RSoft.Entry.Infra.Tables.Entry", b =>
                {
                    b.HasOne("RSoft.Entry.Infra.Tables.Category", "Category")
                        ...
                        .HasConstraintName("FK_Entry_CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RSoft.Entry.Infra.Tables.User", "ChangedAuthor")
                        .WithMany("ChangedEntries")
                        .HasForeignKey("ChangedBy")
                        .HasConstraintName("FK__User_Entry_ChangedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("RSoft.Entry.Infra.Tables.User", "CreatedAuthor")
                        .WithMany("CreatedEntries")
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("FK_User_Entry_CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("RSoft.Entry.Infra.Tables.Transaction", b =>
                {
                    ...
                    b.HasOne("RSoft.Entry.Infra.Tables.Entry", "Entry")
                        .WithMany("Transactions")
                        .HasForeignKey("EntryId")
                        .HasConstraintName("FK_User_Transaction_EntryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
